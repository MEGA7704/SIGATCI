export const MODULE_CONFIG={
  personnel:{title:'Personnel',singular:'Agent',subtitle:'Gestion des agents, matricules, fonctions et statuts.',fields:[['date_naissance','Date de naissance','date'],['lieu_naissance','Lieu de naissance','text'],['photo','Photo de l’agent','image'],['matricule','Matricule','text'],['emploi','Emploi','text'],['fonction','Fonction','text'],['categorie','Catégorie','text'],['grade','Grade','text'],['classe','Classe','text'],['echelon','Échelon','text'],['date_prise_service_minef','Date de prise de service au MINEF','date'],['date_prise_service_gbeke','Date de prise de service dans la Région','date'],['handicap','Handicap','text'],['situation_matrimoniale','Situation matrimoniale','text'],['telephone','Numéro de téléphone','tel']]},
  ...
  missions:{title:'Missions',singular:'Mission',subtitle:'Missions, équipes, objectifs, résultats et rapports.',fields:[],missionTypes:{
    ...
    REPRESSION:{label:'Répression des infractions',singular:'Répression d’infraction',addLabel:'Ajouter répression',backendModule:'missions',fields:[
      ['chef_mission','Chef de mission','agent-select'],['agents_arrestation','Autres agents ayant procédé à l’intervention','textarea'],
    ...
    ['__section_affaire','Informations automatiques reprises de la répression liée','section'],['date_controle','Date du contrôle','computed-text'],['heure_controle','Heure du contrôle','computed-text'],['lieu_controle','Lieu précis du contrôle','computed-text'],['chef_mission','Chef de mission','computed-text'],['agents_arrestation','Agent(s) de l’intervention','computed-textarea'],['arrestation','Issue de l’intervention','computed-text'],
