export const MODULE_CONFIG={
  ...
  missions:{title:'Missions',singular:'Mission',subtitle:'Missions, équipes, objectifs, résultats et rapports.',fields:[],missionTypes:{
    ...
    ['objet_infraction','Objet de l’infraction','textarea'],['objets_saisis','Objets saisis','textarea'],['agents_redacteurs','Agent(s) rédacteur(s)','textarea'],['expose_faits','Exposé des faits','textarea'],['declaration_mis_cause','Déclaration de la personne mise en cause','textarea'],['constatations','Constatations','textarea'],['conclusion_suite','Conclusion / suite donnée','textarea']
  ]},
