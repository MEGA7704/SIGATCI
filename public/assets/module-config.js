export const MODULE_CONFIG={
  ...
  missions:{title:'Missions',singular:'Mission',subtitle:'Missions, équipes, objectifs, résultats et rapports.',fields:[],missionTypes:{
    ...
    REPRESSION:{label:'Répression des infractions',singular:'Répression d’infraction',addLabel:'Ajouter répression',backendModule:'infractions',fields:[
      ['__section_liaison','Liée à une mission ?','section'],['liee_mission','Choix','select','oui|non'],['mission_liee_id','N° / intitulé de la mission','mission-realisee-select'],['agents_arrestation','Agent(s) ayant procédé à l’arrestation','textarea'],
      ['objet_infraction','Objet de l’infraction','textarea'],['personne_mise_cause','Personne mise en cause','text'],['contact_mis_cause','Contact','text'],['photo_personne','Photo de la personne mise en cause','image'],['type_numero_piece','Type et numéro de pièce','text'],['photo_piece','Photo de la pièce','image'],['objets_saisis','Objets saisis','textarea'],['photo_objets','Photo des objets saisis','image'],['observations','Observations','textarea']
    ]}
  },offensePvFields:[
    ['numero_pv','N° du P-V','text'],['date_pv','Date du P-V','date'],['lieu_pv','Lieu de rédaction','text'],['agents_redacteurs','Agent(s) rédacteur(s)','textarea'],['personne_mise_cause','Personne mise en cause','text'],['objet_infraction','Objet de l’infraction','textarea'],['objets_saisis','Objets saisis','textarea'],['expose_faits','Exposé des faits','textarea'],['declaration_mis_cause','Déclaration de la personne mise en cause','textarea'],['constatations','Constatations','textarea'],['conclusion_suite','Conclusion / suite donnée','textarea']
  ]},
  ...
  'feux-brousse':{title:'Feux de brousse',singular:'Enregistrement feux de brousse',subtitle:'Sinistres, dégâts et suivi des incidents.',fields:[],fireTypes:{
    REDYNAMISE:{label:'Comités de lutte contre les feux de brousse redynamisés',singular:'Comité redynamisé',addLabel:'Ajouter comité redynamisé',fields:[['departement','Département','text'],['sous_prefecture','Sous-préfecture','text'],['village','Nom du village','text'],['acte_creation','Acte de création','text'],['__section_president','Président du comité','section'],['president_nom','Nom et prénoms','text'],['president_contact','Contact','text']]},
    ...
    RENOUVELE:{label:'Comités de lutte contre les feux de brousse renouvelés',singular:'Comité renouvelé',addLabel:'Ajouter comité renouvelé',fields:[['departement','Département','text'],['sous_prefecture','Sous-préfecture','text'],['village','Nom du village','text'],['acte_creation','Acte de création','text'],['__section_president','Président du comité','section'],['president_nom','Nom et prénoms','text'],['president_contact','Contact','text']]},
