export const MODULE_CONFIG={
  personnel:{title:'Personnel',singular:'Agent',subtitle:'Gestion des agents, matricules, fonctions et statuts.',fields:[['photo','Photo de l’agent','image'],['sexe','Sexe','select','Masculin|Féminin'],['matricule','Matricule','text'],['emploi','Emploi','text'],['date_naissance','Date de naissance','date'],['date_prise_service_minef','Date de prise de service au MINEF','date'],['date_prise_service_gbeke','Date de prise de service dans la Région de Gbêkê','date'],['grade','Grade','text'],['classe','Classe','text'],['echelon','Échelon','text'],['handicap','Handicap','text'],['telephone','Numéro de téléphone','text']]},
