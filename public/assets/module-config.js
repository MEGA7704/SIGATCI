export const MODULE_CONFIG={
  ...
  missions:{title:'Missions',singular:'Mission',subtitle:'Missions, équipes, objectifs, résultats et rapports.',fields:[],missionTypes:{
    ...
    REPRESSION:{label:'Répression des infractions',singular:'Répression d’infraction',addLabel:'Ajouter répression',backendModule:'infractions',fields:[
      ['__section_liaison','Liée à une mission ?','section'],['liee_mission','Choix','select','oui|non'],['mission_liee_id','N° / intitulé de la mission','mission-realisee-select'],['agents_arrestation','Agent(s) ayant procédé à l’intervention','textarea'],
      ['__section_controle','Identification de l’opération de contrôle','section'],['date_controle','Date du contrôle','date'],['heure_controle','Heure du contrôle','time'],['lieu_controle','Lieu précis du contrôle','text'],['arrestation','Arrestation','select','une arrestation|aucune arrestation'],['objet_infraction','Objet / nature de l’infraction','textarea'],
      ['__section_personne','Identification de la personne mise en cause','section'],['personne_mise_cause','Nom et prénoms','text'],['date_naissance_mis_cause','Date de naissance','date'],['lieu_naissance_mis_cause','Lieu de naissance','text'],['profession_mis_cause','Profession','text'],['domicile_mis_cause','Domicile / Localité','text'],['contact_mis_cause','Contact','text'],['photo_personne','Photo de la personne mise en cause','image'],['type_piece_identite','Type de pièce d’identité','select','CNI|Passeport|Permis|Autre'],['numero_piece_identite','Numéro de la pièce','text'],['photo_piece','Photo de la pièce d’identité','image'],
      ['__section_saisie','Objets, produits ou matériels saisis','section'],['objets_saisis','Désignation détaillée des objets / produits / matériels saisis','textarea'],['photo_objets','Photo des objets saisis','image'],['sort_biens','Sort des biens saisis','select','mis sous scellés|déposés|confiés|conservés|laissés sous garde|autre'],['lieu_conservation','Lieu de dépôt / conservation ou responsable','text'],
      ...
      ['__section_suite','Conclusion et suite donnée','section'],['resume_infraction','Résumé de la nature de l’infraction','textarea'],['mesures_prises','Mesures prises / suite donnée','textarea'],['autorite_transmission','Service ou autorité de transmission','text']
    ]}
  },offensePvFields:[
    ['__section_affaire','Informations reprises automatiquement de l’affaire liée','section'],['objet_infraction','Objet de l’infraction','computed-textarea'],['objets_saisis','Objets, produits ou matériels concernés','computed-textarea'],['date_controle','Date du contrôle','computed-text'],['heure_controle','Heure du contrôle','computed-text'],['lieu_controle','Lieu précis du contrôle','computed-text'],['date_naissance_mis_cause','Date de naissance','computed-text'],['lieu_naissance_mis_cause','Lieu de naissance','computed-text'],['profession_mis_cause','Profession','computed-text'],['domicile_mis_cause','Domicile / Localité','computed-text'],['contact_mis_cause','Contact','computed-text'],['type_piece_identite','Type de pièce d’identité','computed-text'],['numero_piece_identite','Numéro de la pièce','computed-text'],['arrestation','Arrestation','computed-text'],['sort_biens','Sort des biens saisis','computed-text'],['lieu_conservation','Lieu de dépôt / conservation','computed-text'],
    ['__section_redaction','Rédaction du procès-verbal','section'],['agents_redacteurs','Agent(s) ayant participé à la mission / intervention','textarea'],['expose_faits','Exposé des faits','textarea'],['declaration_mis_cause','Déclaration de la personne mise en cause','textarea'],['constatations','Constatations','textarea'],['observations_pv','Observations','textarea'],['resume_infraction','Résumé de la nature de l’infraction','textarea'],['mesures_prises','Mesures prises / suite donnée','textarea'],['autorite_transmission','Service ou autorité compétente destinataire','text']
  ]},
